  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <p className="text-muted-foreground mb-8">Configure your API keys and preferences</p>
        ...
        <section className="mb-12">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      {hasKey(provider.id) ? (
                        <Badge className="bg-success-muted text-success-muted-foreground">Connected</Badge>
                      ) : (
          ...
          <div className="mt-4 p-4 bg-info-muted/50 border border-info/20 rounded-lg">
            ...
            <CardContent className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Display estimated cost before generating</p>
                </div>
                <Switch
          ...
          <Card>
            <CardContent className="p-6">
              <div className="grid grid-cols-3 gap-6 text-center">
                <div>
                  <p className="text-3xl font-bold text-brand">{history.length}</p>
                  <p className="text-sm text-muted-foreground">Images Generated</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-info">${totalCost.toFixed(2)}</p>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Saved vs Subscriptions</p>
                </div>
              </div>
