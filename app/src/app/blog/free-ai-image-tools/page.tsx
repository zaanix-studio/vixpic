      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <header className="mb-12">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-sm font-medium px-3 py-1 bg-success-muted text-success-muted-foreground rounded-full">
              Guide
            </span>
        ...
        <div className="prose prose-lg max-w-none">
            ...
            <CardContent className="pt-6 space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/compress" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/resize" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/crop" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/rotate" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
            ...
            <CardContent className="pt-6 space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/convert" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/image-to-pdf" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
            ...
            <CardContent className="pt-6 space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/background-remover" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/upscaler" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/text-extractor" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
            ...
            <CardContent className="pt-6 space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/blur-sharpen" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/filters" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/watermark" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
            ...
            <CardContent className="pt-6 space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/color-picker" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/palette-extractor" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/image-compare" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
            ...
            <CardContent className="pt-6 space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/collage" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/meme-maker" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/splitter" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/qr-generator" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
            ...
            <CardContent className="pt-6 space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/tools/metadata" className="text-brand text-sm hover:underline">
                    Use Tool →
                  </Link>
                </div>
                <p className="text-muted-foreground text-sm">
          ...
          <ol className="list-decimal pl-6 space-y-3 my-6">
            ...
            <li>
              <strong>Bookmark the tools hub.</strong> <Link href="/tools" className="text-brand hover:underline">/tools</Link> has 
            ...
            <Link href="/blog/byok-explained">
              <Card className="hover:border-brand/20 transition-all">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">How BYOK saves money on AI image generation.</p>
                </CardContent>
              </Card>
            </Link>
