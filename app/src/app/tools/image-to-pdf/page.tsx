                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {images.map((img, index) => (
                        <div key={img.id} className="relative group">
                          ...
                          <div className="absolute inset-0 bg-inverted/50 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center gap-1">
                            {index > 0 && (
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                ...
                                className="p-1.5 bg-background rounded-full text-xs hover:bg-muted"
                              >
                                ←
                              </button>
                            )}
                            <button
                              ...
                              className="p-1.5 bg-destructive/50 text-inverted-foreground rounded-full text-xs hover:bg-destructive/90"
                            >
                              ✕
                            </button>
                          ...
                          <div className="absolute top-1 left-1 bg-inverted/60 text-inverted-foreground text-xs px-2 py-0.5 rounded">
                            {index + 1}
                          </div>
                        </div>
                      ))}
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg border-2 text-sm transition-colors ${
                            pageSize === option.value
                              ? "border-brand bg-brand-muted/50 text-brand-muted-foreground"
