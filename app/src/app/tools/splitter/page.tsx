            ...
            <CardContent className="p-6">
              ...
              {selectedImage && tiles.length === 0 && (
                <div className="space-y-6">
                    ...
                    <div className="relative inline-block">
                      ...
                      >
                        {Array.from({ length: gridCols * gridRows }).map((_, i) => (
                          <div
                            key={i}
                            className="border border-background/70 border-dashed"
                  ...
                  {/* Output Info */}
                  <div className="text-center p-3 bg-brand-muted/50 rounded-lg">
              ...
              {tiles.length > 0 && (
                <div className="space-y-6">
                  ...
                  >
                    {tiles.map((tile, index) => (
                      <div key={index} className="relative group">
                        ...
                        />
                        <div className="absolute inset-0 bg-inverted/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded">
                          <button
                            onClick={() => downloadTile(tile, index)}
                            className="bg-background text-foreground px-3 py-1 rounded text-sm font-medium"
                          >
                            Download
                          </button>
                        </div>
                        <span className="absolute top-1 left-1 bg-inverted/60 text-inverted-foreground text-xs px-1.5 py-0.5 rounded">
                          {index + 1}
                        </span>
                      </div>
                    ))}
                  ...
                  {/* Instagram Tip */}
                  <div className="p-4 bg-info-muted/50 border border-info/20 rounded-lg text-center">
