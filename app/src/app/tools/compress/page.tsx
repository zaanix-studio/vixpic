            ...
            <CardContent className="p-6">
              ...
              {selectedImage && (
                <div className="space-y-6">
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {compressedSize > 0 && (
                          <span className="text-sm font-mono">
                            <span className="text-success">{formatBytes(compressedSize)}</span>
                            <span className="text-muted-foreground ml-2">(-{savings}%)</span>
                          </span>
                        )}
                      </div>
                      <div className="relative aspect-square bg-muted rounded-lg overflow-hidden">
                        {compressedImage ? (
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <p className="text-muted-foreground">Click compress to preview</p>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  {/* Stats */}
                  {compressedSize > 0 && (
                    <div className="p-4 bg-success-muted/50 border border-success/20 rounded-lg text-center">
